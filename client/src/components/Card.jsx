...
const Card = ({ type, video }) => {
  ...
  useEffect(() => {
    const fetchannel = async () => {
      ...
      setChannel(res.data);   // res.data will setVideos according response from /videos/random
    }
    fetchannel(); // here we calling function because we cannot give async to useEffect
  }, [video.userId])
